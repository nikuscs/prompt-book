...
export const WINDOW_MAIN_MIN_HEIGHT = 280;
export const WINDOW_MAIN_MAX_HEIGHT = 620;
export const WINDOW_MAIN_LIST_MAX_HEIGHT = 430;

export const WINDOW_MENUBAR_WIDTH = 330;
export const WINDOW_MENUBAR_MIN_HEIGHT = 320;
